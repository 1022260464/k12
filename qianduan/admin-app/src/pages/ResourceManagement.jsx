...
const configs = {
  courses: { title: "课程资源", entityName: "课程", eyebrow: "LEARNING CATALOG", description: "维护课程基础信息、章节顺序和教学正文。", api: coursesApi, icon: BookOpen, fields: [["title", "课程标题"], ["subject", "学科"], ["gradeLevel", "年级"], ["description", "课程描述", "textarea"]], initial: { title: "", subject: "", gradeLevel: "", description: "" }, columns: [["subject", "学科"], ["gradeLevel", "年级"]] },
