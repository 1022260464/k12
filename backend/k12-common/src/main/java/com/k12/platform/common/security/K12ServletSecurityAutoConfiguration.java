    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(requests -> requests
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/iam/users/me/behavior").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/v1/iam/users/me/behavior/off-topic").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/v1/iam/users/me").authenticated()
                        .requestMatchers(HttpMethod.PUT, "/api/v1/iam/users/me").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/v1/iam/users/me/avatar").authenticated()
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/assessments/homeworks/*/questions/*/attachments").hasAnyAuthority(K12Authorities.ROLE_ADMIN, K12Authorities.HOMEWORK_UPDATE)
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/assessments/homeworks/*/questions/*/attachments/*").hasAnyAuthority(K12Authorities.ROLE_ADMIN, K12Authorities.HOMEWORK_UPDATE)
