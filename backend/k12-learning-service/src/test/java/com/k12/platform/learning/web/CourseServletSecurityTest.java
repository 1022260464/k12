...
/** 使用真实公共 Servlet 安全链，模拟的只有 JWT 解码，不访问数据库。 */
@SpringJUnitConfig(CourseServletSecurityTest.Config.class)
@WebAppConfiguration
class CourseServletSecurityTest {
    @Configuration
    @EnableWebMvc
    @EnableWebSecurity
    ...
    static class Config {
        ...
        @Bean JwtDecoder jwtDecoder() { return CourseServletSecurityTest::jwt; }
    }
